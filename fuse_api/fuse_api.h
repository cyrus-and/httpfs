...
int phpfs_fsync( const char * , int phpfs_, struct fuse_file_info * );
int phpfs_setxattr( const char * , const char * , const char * , size_t , int phpfs_ );
...
int phpfs_fsyncdir( const char * , int phpfs_ , struct fuse_file_info * );
int phpfs_access( const char * , int phpfs_ );
...
int phpfs_lock( const char * , struct fuse_file_info * , int phpfs_cmd , struct flock * );
int phpfs_utimens( const char * , const struct timespec tv[2] );
int phpfs_bmap( const char * , size_t blocksize , uint64_t *idx );
int phpfs_ioctl( const char * , int phpfs_cmd , void *arg , struct fuse_file_info * , unsigned int phpfs_flags , void *data );
int phpfs_poll( const char * , struct fuse_file_info * , struct fuse_pollhandle *ph , unsigned *reventsp );
